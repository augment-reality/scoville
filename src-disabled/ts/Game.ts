...
export class Game {
    public bga: Bga<ScovillenewPlayer, ScovillenewGamedatas>;
    private gamedatas: ScovillenewGamedatas;

    private playerTurn: PlayerTurn;

    constructor(bga: Bga<ScovillenewPlayer, ScovillenewGamedatas>) {
    ...
    */
    ...
    setup(gamedatas: ScovillenewGamedatas) {
